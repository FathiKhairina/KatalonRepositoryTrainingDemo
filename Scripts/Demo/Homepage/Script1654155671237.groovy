...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Employee Name_empsearchemployee_nameempName'), 'rina')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/li_Employee Name                      var e_865399'))
